...
class Apps:
    ...
    def get_processed_template(self, request):
        ...
        apps_config = bonfire._process(
            ...
            AppOrComponentSelector(bool(request.get("remove_resources")), request.get("remove_resources", []), []),
            AppOrComponentSelector(bool(request["no_remove_resources"]), request.get("no_remove_resources", []), []),
            AppOrComponentSelector(bool(request["remove_dependencies"]), [], request.get("remove_dependencies",[])),
            AppOrComponentSelector(bool(request["no_remove_dependencies"]), [], request.get("no_remove_dependencies", [])),
